...
let activeSpellDisplayer = new SpellDisplayer(data);
...
function filter() {
    var filterLevel = document.getElementById("spellLevelsInput").value;
    var filterSchool = document.getElementById("spellSchoolsInput").value;
    var filterClass = document.getElementById("spellClassesInput").value;
...
//# sourceMappingURL=SpellViewerScripts.js.map