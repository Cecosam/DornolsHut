...
function setCookie(cookieName: string, cookieValue: any, expiresDate: string = ""): void {
    if (expiresDate == "") 
...
function getCookie(cookieName: string): string {
    ...
    let cookiesArray: string[] = decodeURIComponent(document.cookie).split(';');
    for (let i = 0; i < cookiesArray.length; i++) {
        let cookie: string = cookiesArray[i];
...
function checkIfLastOrderByCookieIsValid(isisLargeDevice: boolean, orderBy: string, arrayForLarge:string[], arrayForSmall:string[]): string {
    let array: string[];
    if (isisLargeDevice) {
        array = arrayForLarge;
...
function changeViewForOnSmallerScreen(e): void {
    if (e.matches) {
...
function getSpellLevelAsText(spellLevel: number): string {

    if (spellLevel == getTheKeyFromEnum<SpellLevelEnum>(SpellLevelEnum, SpellLevelEnum.Cantrip)) {
        return SpellLevelEnum.Cantrip;
    }
    else if (spellLevel == getTheKeyFromEnum<SpellLevelEnum>(SpellLevelEnum, SpellLevelEnum.Level1)) {
        return SpellLevelEnum.Level1;
    }
    else if (spellLevel == getTheKeyFromEnum<SpellLevelEnum>(SpellLevelEnum, SpellLevelEnum.Level2)) {
        return SpellLevelEnum.Level2;
    }
    else if (spellLevel == getTheKeyFromEnum<SpellLevelEnum>(SpellLevelEnum, SpellLevelEnum.Level3)) {
        return SpellLevelEnum.Level3;
    }
    else if (spellLevel == getTheKeyFromEnum<SpellLevelEnum>(SpellLevelEnum, SpellLevelEnum.Level4)) {
        return SpellLevelEnum.Level4;
    }
    else if (spellLevel == getTheKeyFromEnum<SpellLevelEnum>(SpellLevelEnum, SpellLevelEnum.Level5)) {
        return SpellLevelEnum.Level5;
    }
    else if (spellLevel == getTheKeyFromEnum<SpellLevelEnum>(SpellLevelEnum, SpellLevelEnum.Level6)) {
        return SpellLevelEnum.Level6;
    }
    else if (spellLevel == getTheKeyFromEnum<SpellLevelEnum>(SpellLevelEnum, SpellLevelEnum.Level7)) {
        return SpellLevelEnum.Level7;
    }
    else if (spellLevel == getTheKeyFromEnum<SpellLevelEnum>(SpellLevelEnum, SpellLevelEnum.Level8)) {
        return SpellLevelEnum.Level8;
    }
    else if (spellLevel == getTheKeyFromEnum<SpellLevelEnum>(SpellLevelEnum, SpellLevelEnum.Level9)) {
        return SpellLevelEnum.Level9;
    }
}
function replaceAtFunc(inputWord: string, wordToReplace: string, index: number, replacement: string): string {
...
function addInfoToTheToolTip(container, propertyName: string, propertyContent: string): void {
...
function clearElements(element: HTMLElement): void {
...
function addTdElementWithClass(className: string, text: string): HTMLElement {
...
function addHeadOfTable(id: string): HTMLElement {
...
function getTheKeyFromEnum<T>(enumeration: any, enumerationValue: T): number {
    let keys = Object.keys((enumeration as T) as object);
    for (var i = 0; i < keys.length; i++) {
        if ((enumeration as T)[keys[i]].toLowerCase() == (enumerationValue as string).toLowerCase()) {
            return i;
        }
    }
...
getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.Shield);
function getArmorName(armorName: string): number {
    if (ArmorNameEnum.Padded == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.Padded);
    else if (ArmorNameEnum.Leather == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.Leather);
    else if (ArmorNameEnum.StuddedLeather == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.StuddedLeather);
    else if (ArmorNameEnum.Hide == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.Hide);
    else if (ArmorNameEnum.ChainShirt == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.ChainShirt);
    else if (ArmorNameEnum.ScaleMail == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.ScaleMail);
    else if (ArmorNameEnum.Breastplate == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.Breastplate);
    else if (ArmorNameEnum.HalfPlate == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.HalfPlate);
    else if (ArmorNameEnum.RingMail == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.RingMail);
    else if (ArmorNameEnum.ChainMail == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.ChainMail);
    else if (ArmorNameEnum.Splint == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.Splint);
    else if (ArmorNameEnum.Plate == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.Plate);
    else if (ArmorNameEnum.Shield == armorName)
        return getTheKeyFromEnum<ArmorNameEnum>(ArmorNameEnum, ArmorNameEnum.Shield);
}
...
function getCategory(category: number): string {
    if (category == getTheKeyFromEnum<CategoryEnum>(CategoryEnum, CategoryEnum.Potions))
        return CategoryEnum.Potions;
    else if (category == getTheKeyFromEnum<CategoryEnum>(CategoryEnum, CategoryEnum.Treasures))
        return CategoryEnum.Treasures;
    else if (category == getTheKeyFromEnum<CategoryEnum>(CategoryEnum, CategoryEnum.Rings))
        return CategoryEnum.Rings;
    else if (category == getTheKeyFromEnum<CategoryEnum>(CategoryEnum, CategoryEnum.Armors))
        return CategoryEnum.Armors;
    else if (category == getTheKeyFromEnum<CategoryEnum>(CategoryEnum, CategoryEnum.Poisons))
        return CategoryEnum.Poisons;
    else if (category == getTheKeyFromEnum<CategoryEnum>(CategoryEnum, CategoryEnum.SimpleWeapons))
        return CategoryEnum.SimpleWeapons;
    else if (category == getTheKeyFromEnum<CategoryEnum>(CategoryEnum, CategoryEnum.MartialWeapons))
        return CategoryEnum.MartialWeapons;
    else if (category == getTheKeyFromEnum<CategoryEnum>(CategoryEnum, CategoryEnum.Rods))
        return CategoryEnum.Rods;
    else if (category == getTheKeyFromEnum<CategoryEnum>(CategoryEnum, CategoryEnum.Staffs))
        return CategoryEnum.Staffs;
    else if (category == getTheKeyFromEnum<CategoryEnum>(CategoryEnum, CategoryEnum.Wands))
        return CategoryEnum.Wands;
    else if (category == getTheKeyFromEnum<CategoryEnum>(CategoryEnum, CategoryEnum.WondrousItems))
        return CategoryEnum.WondrousItems;
}
function getArmorType(type: number): string {
    if (type == getTheKeyFromEnum<ArmorTypeEnum>(ArmorTypeEnum, ArmorTypeEnum.Light))
        return ArmorTypeEnum.Light;
    else if (type == getTheKeyFromEnum<ArmorTypeEnum>(ArmorTypeEnum, ArmorTypeEnum.Medium))
        return ArmorTypeEnum.Medium;
    else if (type == getTheKeyFromEnum<ArmorTypeEnum>(ArmorTypeEnum, ArmorTypeEnum.Heavy))
...
function changeClassOfTooltipInnerDivLeftTop(event): void {
...
function changeClassOfTooltipInnerDivLeftUpLeftDown(event): void {
...
function changeClassOfTooltipInnerDivRightUpRightDown(event): void {
